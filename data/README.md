...
## Official national income series for the home page

The home-page income trend no longer uses the commune-derived FiLoSoFi aggregation from `public/data/filosofi_summaries.json` as its primary source.
...
- local FiLoSoFi parquet assets remain the source for exploration and territorial analysis;
- the home-page revenue chart uses the official national series whenever it is publicly available.
